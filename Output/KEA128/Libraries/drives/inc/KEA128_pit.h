...
//------------------------------------以下代码用于获取PIT计时时间------------------------------------
#define     pit_get_ms(PITn_e,ms)           pit_time_get(PITn_e) / bus_clk_khz;                 //获取PIT计时时间  单位ms
#define     pit_get_us(PITn_e,us)           pit_time_get(PITn_e) * 1000 / bus_clk_khz;          //获取PIT计时时间  单位us
#define     pit_get_ns(PITn_e,ns)           pit_time_get(PITn_e) * 1000000 / bus_clk_khz;       //获取PIT计时时间  单位ns(40M总线频率时最小单位为25ns)
