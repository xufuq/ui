...
struct qt_meta_stringdata_BaseInfo_t {
    QByteArrayData data[1];
    char stringdata0[9];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_BaseInfo_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BaseInfo_t qt_meta_stringdata_BaseInfo = {
    {
QT_MOC_LITERAL(0, 0, 8) // "BaseInfo"
...
const QMetaObject BaseInfo::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BaseInfo.data,
      qt_meta_data_BaseInfo,  qt_static_metacall, nullptr, nullptr}
};
...
void *BaseInfo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_BaseInfo.stringdata0))
